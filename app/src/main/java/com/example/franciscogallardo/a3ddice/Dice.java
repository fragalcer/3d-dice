...
public class Dice {
    ...
    private int[] imageFileIDs = {
            R.drawable.dice_kyusho_r_1,
            R.drawable.dice_kyusho_r_2,
            R.drawable.dice_kyusho_r_6,
            R.drawable.dice_kyusho_r_5,
            R.drawable.dice_kyusho_r_3,
            R.drawable.dice_kyusho_r_4
    };
